...
export default function () {
    ...
    const allTabs = useMemo(() => [{title: "Checklist",content: (<Container><div class="row"><Checklist ></Checklist></div></Container>)},{title: "Setup/Auto",content: (<Container><div class="row"></div></Container>)},{title: "TeleOp",content: (<Container><div class="row"><div class="col-2 column"><div class="column-item bubble"><FieldMap socket={socket} id={4} alliance ></FieldMap></div></div><div class="col-6 column"><DashboardSubRow><div class="bubble"><CameraFeed port={5801} ></CameraFeed></div><div class="bubble"><CameraFeed port={5802} ></CameraFeed></div></DashboardSubRow><DashboardSubRow><div class="bubble"><CameraFeed port={5803} ></CameraFeed></div><div class="bubble"><CameraFeed port={5804} ></CameraFeed></div></DashboardSubRow></div><div class="col-4 column"><div class="column-item bubble"><Overrides socket={socket} columns={2} id={5} switches={[{ label: "Limelight PowerSaver"},{ label: "Disable Camera Feeds"},{ label: "CompMode"},{ label: "Disable Shot Smoothing"},{ label: "Manual Climb"},{ label: "Manual Aim"}]} ></Overrides></div></div></div></Container>)},{title: "Subsystems",content: (<Container><div class="row"><div class="col-4 column"><div class="column-item bubble"><SwerveModules socket={socket} id={6} ></SwerveModules></div></div><div class="col-3 column"><div class="column-item bubble"><Placeholder text={"Climb"} height={20} ></Placeholder></div></div><div class="col-5 column"><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Shooter"} id={7} velocity ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Intake"} id={8} velocity ></SimpleSubsystem></div></DashboardSubRow><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Indexer"} id={9} velocity ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Spindexer"} id={10} velocity ></SimpleSubsystem></div></DashboardSubRow><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Turret"} id={11} ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Turret Hood"} id={12} absolute ></SimpleSubsystem></div></DashboardSubRow></div></div></Container>)},], []);
