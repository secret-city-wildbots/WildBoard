...
import AutoChooser from "C:/Users/jaspe/coding/WildBoard/src/main/deploy/WildBoard/frontend/src/panels/AutoChooser.tsx";
...
import SystemsCheck from "C:/Users/jaspe/coding/WildBoard/src/main/deploy/WildBoard/frontend/src/panels/SystemsCheck.tsx";
...
export default function () {
    ...
    const allTabs = useMemo(() => [{title: "Checklist",content: (<Container><div class="row"><Checklist ></Checklist></div></Container>)},{title: "TeleOp",content: (<Container><div class="row"><div class="col-2 column"><div class="column-item bubble"><FieldMap socket={socket} id={4} alliance ></FieldMap></div></div><div class="col-6 column"><DashboardSubRow><div class="bubble"><CameraFeed port={5800} ></CameraFeed></div><div class="bubble"><CameraFeed port={5801} ></CameraFeed></div></DashboardSubRow><DashboardSubRow><div class="bubble"><CameraFeed port={5802} ></CameraFeed></div><div class="bubble"><CameraFeed port={5803} ></CameraFeed></div></DashboardSubRow></div><div class="col-4 column"><div class="column-item bubble"><AutoChooser socket={socket} id={5} autos={["Go Forward","Move Fast"]} ></AutoChooser></div><div class="column-item bubble"><Overrides socket={socket} columns={2} id={6} switches={[{ label: "Limelight PowerSaver"},{ label: "Disable Camera Feeds"},{ label: "CompMode"},{ label: "Disable Shot Smoothing"},{ label: "Always Aim at Hub"},{ label: "Disable Shoot Safeties"}]} ></Overrides></div></div></div></Container>)},{title: "Subsystems",content: (<Container><div class="row"><div class="col-4 column"><div class="column-item bubble"><SwerveModules socket={socket} id={7} ></SwerveModules></div><div class="column-item bubble"><SystemsCheck socket={socket} id={8} ></SystemsCheck></div></div><div class="col-3 column"><div class="column-item bubble"><Placeholder text={"Climb"} height={20} ></Placeholder></div></div><div class="col-5 column"><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Shooter"} id={9} velocity ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Intake"} id={10} velocity ></SimpleSubsystem></div></DashboardSubRow><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Indexer"} id={11} velocity ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Spindexer"} id={12} velocity ></SimpleSubsystem></div></DashboardSubRow><DashboardSubRow><div class="bubble"><SimpleSubsystem socket={socket} name={"Turret"} id={13} ></SimpleSubsystem></div><div class="bubble"><SimpleSubsystem socket={socket} name={"Turret Hood"} id={14} absolute ></SimpleSubsystem></div></DashboardSubRow></div></div></Container>)},], []);
